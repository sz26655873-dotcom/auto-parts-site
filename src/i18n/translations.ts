...
export const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    'contact.addressValue': 'No. 88 Industrial Zone, Ningbo, Zhejiang, China 315000',
  ...
  zh: {
    ...
    'contact.phone': '电话',
    'contact.address': '地址',
    'contact.addressValue': '中国浙江省宁波市工业区88号 315000',
  ...
  ru: {
    ...
    'contact.addressValue': 'Промышленная зона №88, Нинбо, провинция Чжэцзян, Китай, 315000',
  ...
  ar: {
    ...
    'contact.addressValue': 'المنطقة الصناعية رقم 88، نينغبو، مقاطعة تشجيانغ، الصين 315000',
  ...
  ko: {
    ...
    'contact.phone': '전화',
    'contact.address': '주소',
    'contact.addressValue': '중국 저장성 닝보시 산업단지 88호 315000',
